<template>
  <el-container style="min-height: 100vh;height: 100%; border: 1px solid #eee; display: flex;">
    <el-aside :width="aside_witdh" style="background-color: rgb(238, 241, 246); margin-left: -1px;">
      <Aside :isCollapse="isCollapse"></Aside>
    </el-aside>

    <el-container style="height: 100%; flex: 1;">
